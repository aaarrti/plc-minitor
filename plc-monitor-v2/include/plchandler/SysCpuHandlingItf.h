...
typedef void (CDECL CDECL_EXT* PFSYSCPUATOMICADD_IEC) (syscpuatomicadd_struct *p);
	...
	#define EXP_syscpuatomicadd  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscpuatomicadd", (RTS_UINTPTR)syscpuatomicadd, 1, 0x414E4706, 0x03051100) 
	...
	#define EXP_SysCpuHandlingsyscpuatomicadd  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscpuatomicadd", (RTS_UINTPTR)syscpuatomicadd, 1, 0x414E4706, 0x03051100) 
	...
	#define GET_syscpuatomicadd(fl)  s_pfCMGetAPI2( "syscpuatomicadd", (RTS_VOID_FCTPTR *)&pfsyscpuatomicadd, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x414E4706, 0x03051100)
...
typedef void (CDECL CDECL_EXT* PFSYSCPUATOMICADD64_IEC) (syscpuatomicadd64_struct *p);
	...
	#define EXP_syscpuatomicadd64  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscpuatomicadd64", (RTS_UINTPTR)syscpuatomicadd64, 1, 0xA535E8A0, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscpuatomicadd64
	#define EXT_syscpuatomicadd64
	#define GET_syscpuatomicadd64(fl)  CAL_CMGETAPI( "syscpuatomicadd64" ) 
	...
	#define EXP_SysCpuHandlingsyscpuatomicadd64  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscpuatomicadd64", (RTS_UINTPTR)syscpuatomicadd64, 1, 0xA535E8A0, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_syscpuatomicadd64
	#define EXT_syscpuatomicadd64
	#define GET_syscpuatomicadd64(fl)  CAL_CMGETAPI( "syscpuatomicadd64" ) 
	...
	#define GET_syscpuatomicadd64(fl)  s_pfCMGetAPI2( "syscpuatomicadd64", (RTS_VOID_FCTPTR *)&pfsyscpuatomicadd64, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0xA535E8A0, 0x03051100)
 ...
 * 
 * The function compares the pAddress value with the pCompareValue value.
 * If the pAddress value is equal to the pCompareValue value, the pSwapValue value is stored in the address specified by pAddress.
 * Otherwise, no operation is performed.
 * 
 * The function was successful if the *pSwapValue value is stored in the address specified by pAddress.
 * </description>
 * <result><p>RESULT: Returns ERR_OK if the swap was successful (if the pSwapValue value is stored in the address specified by pAddress)
 * </p></result>
 * <SIL2/>
 */
...
typedef void (CDECL CDECL_EXT* PFSYSCPUATOMICCOMPAREANDSWAP_IEC) (syscpuatomiccompareandswap_struct *p);
	...
	#define EXP_syscpuatomiccompareandswap  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscpuatomiccompareandswap", (RTS_UINTPTR)syscpuatomiccompareandswap, 1, 0xCBB4ED00, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscpuatomiccompareandswap
	#define EXT_syscpuatomiccompareandswap
	#define GET_syscpuatomiccompareandswap(fl)  CAL_CMGETAPI( "syscpuatomiccompareandswap" ) 
	...
	#define EXP_SysCpuHandlingsyscpuatomiccompareandswap  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscpuatomiccompareandswap", (RTS_UINTPTR)syscpuatomiccompareandswap, 1, 0xCBB4ED00, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_syscpuatomiccompareandswap
	#define EXT_syscpuatomiccompareandswap
	#define GET_syscpuatomiccompareandswap(fl)  CAL_CMGETAPI( "syscpuatomiccompareandswap" ) 
	...
	#define GET_syscpuatomiccompareandswap(fl)  s_pfCMGetAPI2( "syscpuatomiccompareandswap", (RTS_VOID_FCTPTR *)&pfsyscpuatomiccompareandswap, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0xCBB4ED00, 0x03051100)
 ...
 * 
 * NOTE:
 * A call to the function SysCpuCallIecFuncWithParams
 * with the parameter values <pointer (not equal to NULL)> in pParam and <0> in iSize
 * has the same result as a call with the parameter values <NULL pointer> in pParam and <0> in iSize.
 * Both result in a call without parameters of the function passed in parameter pfIECFunc.
 *
 * IN GENERAL:
 * An IEC function must always be called with the parameters according to its definition.
 * If an IEC function is called with parameters which do not correspond to the definition of the IEC function,
 * the CODESYS Control runtime system may CRASH.
 * 
...
typedef void (CDECL CDECL_EXT* PFSYSCPUCALLIECFUNCWITHPARAMS_IEC) (syscpucalliecfuncwithparams_struct *p);
	...
	#define EXP_syscpucalliecfuncwithparams  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscpucalliecfuncwithparams", (RTS_UINTPTR)syscpucalliecfuncwithparams, 1, RTSITF_GET_SIGNATURE(0, 0x837FB349), 0x03051100) 
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscpucalliecfuncwithparams
	#define EXT_syscpucalliecfuncwithparams
	#define GET_syscpucalliecfuncwithparams(fl)  CAL_CMGETAPI( "syscpucalliecfuncwithparams" ) 
	...
	#define EXP_SysCpuHandlingsyscpucalliecfuncwithparams  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscpucalliecfuncwithparams", (RTS_UINTPTR)syscpucalliecfuncwithparams, 1, RTSITF_GET_SIGNATURE(0, 0x837FB349), 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_syscpucalliecfuncwithparams
	#define EXT_syscpucalliecfuncwithparams
	#define GET_syscpucalliecfuncwithparams(fl)  CAL_CMGETAPI( "syscpucalliecfuncwithparams" ) 
	...
	#define GET_syscpucalliecfuncwithparams(fl)  s_pfCMGetAPI2( "syscpucalliecfuncwithparams", (RTS_VOID_FCTPTR *)&pfsyscpucalliecfuncwithparams, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, RTSITF_GET_SIGNATURE(0, 0x837FB349), 0x03051100)
...
typedef void (CDECL CDECL_EXT* PFSYSCPUTESTANDRESET_IEC) (syscputestandreset_struct *p);
	...
	#define EXP_syscputestandreset  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscputestandreset", (RTS_UINTPTR)syscputestandreset, 1, RTSITF_GET_SIGNATURE(0, 0xCD8E165F), 0x03051100) 
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscputestandreset
	#define EXT_syscputestandreset
	#define GET_syscputestandreset(fl)  CAL_CMGETAPI( "syscputestandreset" ) 
	...
	#define EXP_SysCpuHandlingsyscputestandreset  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscputestandreset", (RTS_UINTPTR)syscputestandreset, 1, RTSITF_GET_SIGNATURE(0, 0xCD8E165F), 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_syscputestandreset
	#define EXT_syscputestandreset
	#define GET_syscputestandreset(fl)  CAL_CMGETAPI( "syscputestandreset" ) 
	...
	#define GET_syscputestandreset(fl)  s_pfCMGetAPI2( "syscputestandreset", (RTS_VOID_FCTPTR *)&pfsyscputestandreset, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, RTSITF_GET_SIGNATURE(0, 0xCD8E165F), 0x03051100)
...
typedef void (CDECL CDECL_EXT* PFSYSCPUTESTANDSET_IEC) (syscputestandset_struct *p);
	...
	#define EXP_syscputestandset  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscputestandset", (RTS_UINTPTR)syscputestandset, 1, RTSITF_GET_SIGNATURE(0, 0xC50F8C00), 0x03051100) 
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscputestandset
	#define EXT_syscputestandset
	#define GET_syscputestandset(fl)  CAL_CMGETAPI( "syscputestandset" ) 
	...
	#define EXP_SysCpuHandlingsyscputestandset  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscputestandset", (RTS_UINTPTR)syscputestandset, 1, RTSITF_GET_SIGNATURE(0, 0xC50F8C00), 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_syscputestandset
	#define EXT_syscputestandset
	#define GET_syscputestandset(fl)  CAL_CMGETAPI( "syscputestandset" ) 
	...
	#define GET_syscputestandset(fl)  s_pfCMGetAPI2( "syscputestandset", (RTS_VOID_FCTPTR *)&pfsyscputestandset, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, RTSITF_GET_SIGNATURE(0, 0xC50F8C00), 0x03051100)
...
typedef void (CDECL CDECL_EXT* PFSYSCPUTESTANDSETBIT_IEC) (syscputestandsetbit_struct *p);
	...
	#define EXP_syscputestandsetbit  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscputestandsetbit", (RTS_UINTPTR)syscputestandsetbit, 1, 0x6A76133F, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscputestandsetbit
	#define EXT_syscputestandsetbit
	#define GET_syscputestandsetbit(fl)  CAL_CMGETAPI( "syscputestandsetbit" ) 
	...
	#define EXP_SysCpuHandlingsyscputestandsetbit  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"syscputestandsetbit", (RTS_UINTPTR)syscputestandsetbit, 1, 0x6A76133F, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_syscputestandsetbit
	#define EXT_syscputestandsetbit
	#define GET_syscputestandsetbit(fl)  CAL_CMGETAPI( "syscputestandsetbit" ) 
	...
	#define GET_syscputestandsetbit(fl)  s_pfCMGetAPI2( "syscputestandsetbit", (RTS_VOID_FCTPTR *)&pfsyscputestandsetbit, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x6A76133F, 0x03051100)
 ...
 * <result>Error code: returns if Bit could be set/reset successfully, or if any  problem occurred</result>
 */
RTS_RESULT CDECL SysCpuTestAndSetBit2(void *pMemory, RTS_SIZE siLen, RTS_SIZE siBit, RTS_BOOL bSet);
typedef RTS_RESULT (CDECL * PFSYSCPUTESTANDSETBIT2) (void *pMemory, RTS_SIZE siLen, RTS_SIZE siBit, RTS_BOOL bSet);
#if defined(SYSCPUHANDLING_NOTIMPLEMENTED) || defined(SYSCPUTESTANDSETBIT2_NOTIMPLEMENTED)
	#define USE_SysCpuTestAndSetBit2
	#define EXT_SysCpuTestAndSetBit2
	#define GET_SysCpuTestAndSetBit2(fl)  ERR_NOTIMPLEMENTED
	#define CAL_SysCpuTestAndSetBit2(p0,p1,p2,p3)  (RTS_RESULT)ERR_NOTIMPLEMENTED
	#define CHK_SysCpuTestAndSetBit2  FALSE
	#define EXP_SysCpuTestAndSetBit2  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_SysCpuTestAndSetBit2
	#define EXT_SysCpuTestAndSetBit2
	#define GET_SysCpuTestAndSetBit2(fl)  CAL_CMGETAPI( "SysCpuTestAndSetBit2" ) 
	#define CAL_SysCpuTestAndSetBit2  SysCpuTestAndSetBit2
	#define CHK_SysCpuTestAndSetBit2  TRUE
	#define EXP_SysCpuTestAndSetBit2  CAL_CMEXPAPI( "SysCpuTestAndSetBit2" ) 
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_SysCpuTestAndSetBit2
	#define EXT_SysCpuTestAndSetBit2
	#define GET_SysCpuTestAndSetBit2(fl)  CAL_CMGETAPI( "SysCpuTestAndSetBit2" ) 
	#define CAL_SysCpuTestAndSetBit2  SysCpuTestAndSetBit2
	#define CHK_SysCpuTestAndSetBit2  TRUE
	#define EXP_SysCpuTestAndSetBit2  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"SysCpuTestAndSetBit2", (RTS_UINTPTR)SysCpuTestAndSetBit2, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_SysCpuHandlingSysCpuTestAndSetBit2
	#define EXT_SysCpuHandlingSysCpuTestAndSetBit2
	#define GET_SysCpuHandlingSysCpuTestAndSetBit2  ERR_OK
	#define CAL_SysCpuHandlingSysCpuTestAndSetBit2 pISysCpuHandling->ISysCpuTestAndSetBit2
	#define CHK_SysCpuHandlingSysCpuTestAndSetBit2 (pISysCpuHandling != NULL)
	#define EXP_SysCpuHandlingSysCpuTestAndSetBit2  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_SysCpuTestAndSetBit2
	#define EXT_SysCpuTestAndSetBit2
	#define GET_SysCpuTestAndSetBit2(fl)  CAL_CMGETAPI( "SysCpuTestAndSetBit2" ) 
	#define CAL_SysCpuTestAndSetBit2 pISysCpuHandling->ISysCpuTestAndSetBit2
	#define CHK_SysCpuTestAndSetBit2 (pISysCpuHandling != NULL)
	#define EXP_SysCpuTestAndSetBit2  CAL_CMEXPAPI( "SysCpuTestAndSetBit2" ) 
#else /* DYNAMIC_LINK */
	#define USE_SysCpuTestAndSetBit2  PFSYSCPUTESTANDSETBIT2 pfSysCpuTestAndSetBit2;
	#define EXT_SysCpuTestAndSetBit2  extern PFSYSCPUTESTANDSETBIT2 pfSysCpuTestAndSetBit2;
	#define GET_SysCpuTestAndSetBit2(fl)  s_pfCMGetAPI2( "SysCpuTestAndSetBit2", (RTS_VOID_FCTPTR *)&pfSysCpuTestAndSetBit2, (fl), 0, 0)
...
typedef struct
{
	...
	PFSYSCPUFLUSHINSTRUCTIONCACHE ISysCpuFlushInstructionCache;
 	...
 	PFSYSCPUTESTANDSETBIT2 ISysCpuTestAndSetBit2;
...
class ISysCpuHandling : public IBase
{
	public:
		...
		virtual RTS_RESULT CDECL ISysCpuTestAndSetBit2(void *pMemory, RTS_SIZE siLen, RTS_SIZE siBit, RTS_BOOL bSet) =0;
