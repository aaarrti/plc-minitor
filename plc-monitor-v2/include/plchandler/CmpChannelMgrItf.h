...
/* Meta-packages */
#define PT_NOTIFICATION     (0x80 + 0x01)	/* not yet implemented */
#define PT_RTSINFO          (0x80 + 0x02)	/* withdrawn by version 3.5.17.0 - do not use */
#define PT_OPENCHANNEL      (0x80 + 0x03)
#define PT_CLOSECHANNEL     (0x80 + 0x04)

/* Meta-packages from client to server (requests) */
#define PT_RTSINFO_REQ      (0xC0 + 0x02)	/* withdrawn by version 3.5.17.0 - do not use */
