...
typedef void (CDECL CDECL_EXT* PFSIL2CHECKCALLERCONTEXT_IEC) (sil2checkcallercontext_struct *p);
	...
	#define CAL_sil2checkcallercontext  sil2checkcallercontext
	#define CHK_sil2checkcallercontext  TRUE
	#define EXP_sil2checkcallercontext  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2checkcallercontext", (RTS_UINTPTR)sil2checkcallercontext, 1, 0x829BB451, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2checkcallercontext
	#define EXT_sil2checkcallercontext
	#define GET_sil2checkcallercontext(fl)  CAL_CMGETAPI( "sil2checkcallercontext" ) 
	...
	#define EXP_CmpSIL2sil2checkcallercontext  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2checkcallercontext", (RTS_UINTPTR)sil2checkcallercontext, 1, 0x829BB451, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_sil2checkcallercontext
	#define EXT_sil2checkcallercontext
	#define GET_sil2checkcallercontext(fl)  CAL_CMGETAPI( "sil2checkcallercontext" ) 
	...
	#define GET_sil2checkcallercontext(fl)  s_pfCMGetAPI2( "sil2checkcallercontext", (RTS_VOID_FCTPTR *)&pfsil2checkcallercontext, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x829BB451, 0x03051100)
	#define CAL_sil2checkcallercontext  pfsil2checkcallercontext
	#define CHK_sil2checkcallercontext  (pfsil2checkcallercontext != NULL)
	#define EXP_sil2checkcallercontext   s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2checkcallercontext", (RTS_UINTPTR)sil2checkcallercontext, 1, 0x829BB451, 0x03051100) 
#endif
...
typedef void (CDECL CDECL_EXT* PFSIL2COPYCODEGUID_IEC) (sil2copycodeguid_struct *p);
	...
	#define EXP_sil2copycodeguid  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2copycodeguid", (RTS_UINTPTR)sil2copycodeguid, 1, 0x638D4565, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2copycodeguid
	#define EXT_sil2copycodeguid
	#define GET_sil2copycodeguid(fl)  CAL_CMGETAPI( "sil2copycodeguid" ) 
	...
	#define EXP_CmpSIL2sil2copycodeguid  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2copycodeguid", (RTS_UINTPTR)sil2copycodeguid, 1, 0x638D4565, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_sil2copycodeguid
	#define EXT_sil2copycodeguid
	#define GET_sil2copycodeguid(fl)  CAL_CMGETAPI( "sil2copycodeguid" ) 
	...
	#define GET_sil2copycodeguid(fl)  s_pfCMGetAPI2( "sil2copycodeguid", (RTS_VOID_FCTPTR *)&pfsil2copycodeguid, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x638D4565, 0x03051100)
...
typedef void (CDECL CDECL_EXT* PFSIL2COPYDATAGUID_IEC) (sil2copydataguid_struct *p);
	...
	#define EXP_sil2copydataguid  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2copydataguid", (RTS_UINTPTR)sil2copydataguid, 1, 0x44F9CD8A, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2copydataguid
	#define EXT_sil2copydataguid
	#define GET_sil2copydataguid(fl)  CAL_CMGETAPI( "sil2copydataguid" ) 
	...
	#define EXP_CmpSIL2sil2copydataguid  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2copydataguid", (RTS_UINTPTR)sil2copydataguid, 1, 0x44F9CD8A, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_sil2copydataguid
	#define EXT_sil2copydataguid
	#define GET_sil2copydataguid(fl)  CAL_CMGETAPI( "sil2copydataguid" ) 
	...
	#define GET_sil2copydataguid(fl)  s_pfCMGetAPI2( "sil2copydataguid", (RTS_VOID_FCTPTR *)&pfsil2copydataguid, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x44F9CD8A, 0x03051100)
...
typedef void (CDECL CDECL_EXT* PFSIL2OEMEXCEPTION_IEC) (sil2oemexception_struct *p);
	...
	#define CAL_sil2oemexception  sil2oemexception
	#define CHK_sil2oemexception  TRUE
	#define EXP_sil2oemexception  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemexception", (RTS_UINTPTR)sil2oemexception, 1, 0xA54830DE, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2oemexception
	#define EXT_sil2oemexception
	#define GET_sil2oemexception(fl)  CAL_CMGETAPI( "sil2oemexception" ) 
	...
	#define EXP_CmpSIL2sil2oemexception  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemexception", (RTS_UINTPTR)sil2oemexception, 1, 0xA54830DE, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_sil2oemexception
	#define EXT_sil2oemexception
	#define GET_sil2oemexception(fl)  CAL_CMGETAPI( "sil2oemexception" ) 
	...
	#define GET_sil2oemexception(fl)  s_pfCMGetAPI2( "sil2oemexception", (RTS_VOID_FCTPTR *)&pfsil2oemexception, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0xA54830DE, 0x03051100)
	#define CAL_sil2oemexception  pfsil2oemexception
	#define CHK_sil2oemexception  (pfsil2oemexception != NULL)
	#define EXP_sil2oemexception   s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemexception", (RTS_UINTPTR)sil2oemexception, 1, 0xA54830DE, 0x03051100) 
#endif
...
typedef void (CDECL CDECL_EXT* PFSIL2ADDLOG_IEC) (sil2addlog_struct *p);
	...
	#define CAL_sil2addlog  sil2addlog
	#define CHK_sil2addlog  TRUE
	#define EXP_sil2addlog  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2addlog", (RTS_UINTPTR)sil2addlog, 1, 0x742BC625, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2addlog
	#define EXT_sil2addlog
	#define GET_sil2addlog(fl)  CAL_CMGETAPI( "sil2addlog" ) 
	...
	#define EXP_CmpSIL2sil2addlog  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2addlog", (RTS_UINTPTR)sil2addlog, 1, 0x742BC625, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_sil2addlog
	#define EXT_sil2addlog
	#define GET_sil2addlog(fl)  CAL_CMGETAPI( "sil2addlog" ) 
	...
	#define GET_sil2addlog(fl)  s_pfCMGetAPI2( "sil2addlog", (RTS_VOID_FCTPTR *)&pfsil2addlog, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x742BC625, 0x03051100)
	#define CAL_sil2addlog  pfsil2addlog
	#define CHK_sil2addlog  (pfsil2addlog != NULL)
	#define EXP_sil2addlog   s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2addlog", (RTS_UINTPTR)sil2addlog, 1, 0x742BC625, 0x03051100) 
#endif
...
typedef void (CDECL CDECL_EXT* PFSIL2OEMGETOPERATIONMODE_IEC) (sil2oemgetoperationmode_struct *p);
	...
	#define CAL_sil2oemgetoperationmode  sil2oemgetoperationmode
	#define CHK_sil2oemgetoperationmode  TRUE
	#define EXP_sil2oemgetoperationmode  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemgetoperationmode", (RTS_UINTPTR)sil2oemgetoperationmode, 1, 0xB292F534, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2oemgetoperationmode
	#define EXT_sil2oemgetoperationmode
	#define GET_sil2oemgetoperationmode(fl)  CAL_CMGETAPI( "sil2oemgetoperationmode" ) 
	...
	#define EXP_CmpSIL2sil2oemgetoperationmode  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemgetoperationmode", (RTS_UINTPTR)sil2oemgetoperationmode, 1, 0xB292F534, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_sil2oemgetoperationmode
	#define EXT_sil2oemgetoperationmode
	#define GET_sil2oemgetoperationmode(fl)  CAL_CMGETAPI( "sil2oemgetoperationmode" ) 
	...
	#define GET_sil2oemgetoperationmode(fl)  s_pfCMGetAPI2( "sil2oemgetoperationmode", (RTS_VOID_FCTPTR *)&pfsil2oemgetoperationmode, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0xB292F534, 0x03051100)
	#define CAL_sil2oemgetoperationmode  pfsil2oemgetoperationmode
	#define CHK_sil2oemgetoperationmode  (pfsil2oemgetoperationmode != NULL)
	#define EXP_sil2oemgetoperationmode   s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemgetoperationmode", (RTS_UINTPTR)sil2oemgetoperationmode, 1, 0xB292F534, 0x03051100) 
#endif
...
typedef void (CDECL CDECL_EXT* PFSIL2OEMGETCALLERCONTEXT_IEC) (sil2oemgetcallercontext_struct *p);
	...
	#define CAL_sil2oemgetcallercontext  sil2oemgetcallercontext
	#define CHK_sil2oemgetcallercontext  TRUE
	#define EXP_sil2oemgetcallercontext  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemgetcallercontext", (RTS_UINTPTR)sil2oemgetcallercontext, 1, 0x2A37A2FD, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2oemgetcallercontext
	#define EXT_sil2oemgetcallercontext
	#define GET_sil2oemgetcallercontext(fl)  CAL_CMGETAPI( "sil2oemgetcallercontext" ) 
	...
	#define EXP_CmpSIL2sil2oemgetcallercontext  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemgetcallercontext", (RTS_UINTPTR)sil2oemgetcallercontext, 1, 0x2A37A2FD, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_sil2oemgetcallercontext
	#define EXT_sil2oemgetcallercontext
	#define GET_sil2oemgetcallercontext(fl)  CAL_CMGETAPI( "sil2oemgetcallercontext" ) 
	...
	#define GET_sil2oemgetcallercontext(fl)  s_pfCMGetAPI2( "sil2oemgetcallercontext", (RTS_VOID_FCTPTR *)&pfsil2oemgetcallercontext, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x2A37A2FD, 0x03051100)
	#define CAL_sil2oemgetcallercontext  pfsil2oemgetcallercontext
	#define CHK_sil2oemgetcallercontext  (pfsil2oemgetcallercontext != NULL)
	#define EXP_sil2oemgetcallercontext   s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemgetcallercontext", (RTS_UINTPTR)sil2oemgetcallercontext, 1, 0x2A37A2FD, 0x03051100) 
#endif
...
typedef void (CDECL CDECL_EXT* PFSIL2OEMGETMEMORYSTATE_IEC) (sil2oemgetmemorystate_struct *p);
	...
	#define CAL_sil2oemgetmemorystate  sil2oemgetmemorystate
	#define CHK_sil2oemgetmemorystate  TRUE
	#define EXP_sil2oemgetmemorystate  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemgetmemorystate", (RTS_UINTPTR)sil2oemgetmemorystate, 1, 0x2FE5CB14, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2oemgetmemorystate
	#define EXT_sil2oemgetmemorystate
	#define GET_sil2oemgetmemorystate(fl)  CAL_CMGETAPI( "sil2oemgetmemorystate" ) 
	...
	#define EXP_CmpSIL2sil2oemgetmemorystate  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemgetmemorystate", (RTS_UINTPTR)sil2oemgetmemorystate, 1, 0x2FE5CB14, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_sil2oemgetmemorystate
	#define EXT_sil2oemgetmemorystate
	#define GET_sil2oemgetmemorystate(fl)  CAL_CMGETAPI( "sil2oemgetmemorystate" ) 
	...
	#define GET_sil2oemgetmemorystate(fl)  s_pfCMGetAPI2( "sil2oemgetmemorystate", (RTS_VOID_FCTPTR *)&pfsil2oemgetmemorystate, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x2FE5CB14, 0x03051100)
	#define CAL_sil2oemgetmemorystate  pfsil2oemgetmemorystate
	#define CHK_sil2oemgetmemorystate  (pfsil2oemgetmemorystate != NULL)
	#define EXP_sil2oemgetmemorystate   s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemgetmemorystate", (RTS_UINTPTR)sil2oemgetmemorystate, 1, 0x2FE5CB14, 0x03051100) 
#endif
...
typedef void (CDECL CDECL_EXT* PFSIL2OEMSTACKISVALID_IEC) (sil2oemstackisvalid_struct *p);
	...
	#define CAL_sil2oemstackisvalid  sil2oemstackisvalid
	#define CHK_sil2oemstackisvalid  TRUE
	#define EXP_sil2oemstackisvalid  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemstackisvalid", (RTS_UINTPTR)sil2oemstackisvalid, 1, 0x56A27207, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2oemstackisvalid
	#define EXT_sil2oemstackisvalid
	#define GET_sil2oemstackisvalid(fl)  CAL_CMGETAPI( "sil2oemstackisvalid" ) 
	...
	#define EXP_CmpSIL2sil2oemstackisvalid  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemstackisvalid", (RTS_UINTPTR)sil2oemstackisvalid, 1, 0x56A27207, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_sil2oemstackisvalid
	#define EXT_sil2oemstackisvalid
	#define GET_sil2oemstackisvalid(fl)  CAL_CMGETAPI( "sil2oemstackisvalid" ) 
	...
	#define GET_sil2oemstackisvalid(fl)  s_pfCMGetAPI2( "sil2oemstackisvalid", (RTS_VOID_FCTPTR *)&pfsil2oemstackisvalid, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x56A27207, 0x03051100)
	#define CAL_sil2oemstackisvalid  pfsil2oemstackisvalid
	#define CHK_sil2oemstackisvalid  (pfsil2oemstackisvalid != NULL)
	#define EXP_sil2oemstackisvalid   s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2oemstackisvalid", (RTS_UINTPTR)sil2oemstackisvalid, 1, 0x56A27207, 0x03051100) 
#endif
...
typedef void (CDECL CDECL_EXT* PFSIL2EXECUTENONSAFETYJOB_IEC) (sil2executenonsafetyjob_struct *p);
	...
	#define EXP_sil2executenonsafetyjob  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2executenonsafetyjob", (RTS_UINTPTR)sil2executenonsafetyjob, 1, 0x142EECAE, 0x03051100) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2executenonsafetyjob
	#define EXT_sil2executenonsafetyjob
	#define GET_sil2executenonsafetyjob(fl)  CAL_CMGETAPI( "sil2executenonsafetyjob" ) 
	...
	#define EXP_CmpSIL2sil2executenonsafetyjob  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"sil2executenonsafetyjob", (RTS_UINTPTR)sil2executenonsafetyjob, 1, 0x142EECAE, 0x03051100) 
#elif defined(CPLUSPLUS)
	#define USE_sil2executenonsafetyjob
	#define EXT_sil2executenonsafetyjob
	#define GET_sil2executenonsafetyjob(fl)  CAL_CMGETAPI( "sil2executenonsafetyjob" ) 
	...
	#define GET_sil2executenonsafetyjob(fl)  s_pfCMGetAPI2( "sil2executenonsafetyjob", (RTS_VOID_FCTPTR *)&pfsil2executenonsafetyjob, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x142EECAE, 0x03051100)
