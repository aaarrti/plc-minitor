...
#define ERR_INVALID_ENCODING	0x0048 /* A string encoding was not correct. */
#define ERR_TARGET_MISMATCH		0x0049 /* Target mismatch detected */
...
#define ERR_CHS_ENCRYPTION_NOT_READY_YET	0x018C /* The CmpSecureChannel is not ready for encrypted communication. Try again later */
...
#define ERR_APP_VERSION_MISMATCH		0x0509 /* Version mismatch of an external plchandler_lib function */
...
#define ERR_CERT_UNKNOWN_ERROR							0x737

#define ERR_P12_UNKNOWN_ERROR							0x750		/* The p12 operation failed for an unknown reason */
#define ERR_P12_MAC_INVALID								0x751		/* The MAC of the p12 operation was invalid. Typically this is because of a wrong passphrase */
#define ERR_P12_UNSUPPORTED_CIPHER						0x752		/* The p12 container was created with an unsupported encryption algorithm */
#define ERR_P12_UNSUPPORTED_DIGEST						0x753		/* The p12 container was created with an unsupported digest algorithm */
#define ERR_P12_UNSUPPORTED_OPTION						0x754		/* The p12 container was created with an unsupported option. */
#define ERR_P12_PARSE_ERROR								0x755		/* The p12 container could not be parsed. */
#define ERR_P12_KEY_NOMATCH								0x756		/* The private key of the p12 container does not match the certifictate within the container. */
#define ERR_P12_NO_KEY									0x757		/* The p12 container does not contain a private key. */
#define ERR_P12_NO_CERT									0x758		/* The p12 container does not contain a certificate. */
...
#define ERR_REDU_TOO_TAGS		                0x0B00	/* Too many tags */
#define ERR_REDU_MEMORY      	                0x0B01	/* Memory error during ID creation */
#define ERR_REDU_CLIENT_CREATION_ERR            0x0B02  /* Client creation error */

/**
 * <category>CFA (CODESYS Firmware Archive) Verifier Issues</category>
 * <description>Errors or warnings encountered while verifying an CFA's signatures.</description>
 */
#define ERR_DM_SIG_SIG_MALFORMED_SIGNERS												0x0B00 /* Malformed list of signers */
#define ERR_DM_SIG_SIG_MALFORMED_SIGNER													0x0B01 /* Malformed signer block */
#define ERR_DM_SIG_SIG_MALFORMED_PUBLIC_KEY												0x0B02 /* Public key embedded in the CFA Signature Scheme v1 signature of this signer could not be parsed. */
#define ERR_DM_SIG_SIG_MALFORMED_CERTIFICATE											0x0B03 /* This CFA Signature Scheme v1 signer's certificate could not be parsed. */
#define ERR_DM_SIG_SIG_MALFORMED_SIGNATURE												0x0B04 /* Failed to parse this signer's signature record contained in the CFA Signature Scheme v1 signature. */
#define ERR_DM_SIG_SIG_MALFORMED_DIGEST													0x0B05 /* Failed to parse this signer's digest record contained in the CFA Signature Scheme v1 signature. */
#define ERR_DM_SIG_SIG_MALFORMED_ADDITIONAL_ATTRIBUTE									0x0B06 /* This CFA Signature Scheme v1 signer contains a malformed additional attribute. */
#define ERR_DM_SIG_SIG_NO_SIGNERS														0x0B07 /* No signers in CFA Signature Scheme v1 signature */
#define ERR_DM_SIG_SIG_UNKNOWN_SIG_ALGORITHM											0x0B08 /* This CFA Signature Scheme v1 signer contains a signature produced using an unknown algorithm. */
#define ERR_DM_SIG_SIG_UNKNOWN_ADDITIONAL_ATTRIBUTE										0x0B09 /* This CFA Signature Scheme v1 signer contains an unknown additional attribute. */
#define ERR_DM_SIG_SIG_VERIFY_ERROR														0x0B0A /* An error was encountered while verifying CFA Signature Scheme v1 signature of this signer. */
#define ERR_DM_SIG_SIG_DID_NOT_VERIFY													0x0B0B /* Signature over signed-data did not verify */
#define ERR_DM_SIG_SIG_NO_SIGNATURES													0x0B0C /* No signatures */
#define ERR_DM_SIG_SIG_NO_SUPPORTED_SIGNATURES											0x0B0D /* No supported signatures */
#define ERR_DM_SIG_SIG_NO_CERTIFICATES													0x0B0E /* No certificates */
#define ERR_DM_SIG_SIG_PUBLIC_KEY_MISMATCH_BETWEEN_CERTIFICATE_AND_SIGNATURES_RECORD	0x0B0F /* This CFA Signature Scheme v1 signer's public key listed in the signer's certificate does not match the public key listed in the signatures record. */
#define ERR_DM_SIG_SIG_SIG_ALG_MISMATCH_BETWEEN_SIGNATURES_AND_DIGESTS_RECORDS			0x0B10 /* This CFA Signature Scheme v1 signer's signature algorithms listed in the signatures record do not match the signature algorithms listed in the signatures record. */
#define ERR_DM_SIG_SIG_CFA_DIGEST_DID_NOT_VERIFY										0x0B11 /* The CFA's digest does not match the digest contained in the CFA Signature Scheme v1 signature. */
#define ERR_DM_SIG_CFA_SIG_BLOCK_UNKNOWN_ENTRY_ID										0x0B12 /* CFA Signing Block contains an unknown entry. */
